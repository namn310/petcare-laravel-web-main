...
<div class="pagetitle">
    ...
    @endif
    <!-- End Page Title -->
    <form id="AddForm" method="post" class="AddForm row mt-4" action="{{ route('admin.createCat') }}"
        ...
        <div class="form-group col-md-4">
            ...
            <input class="form-control" id="nameDM" name="nameDM" onclick="checkName()" onchange="checkName()"
                type="text">
        </div>

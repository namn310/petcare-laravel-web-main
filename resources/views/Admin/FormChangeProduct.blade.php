...
<div class="pagetitle">
    ...
    <div style="background-color: white;padding:20px;border-radius:20px;box-shadow: 2px 2px 2px #FFCC99;">
        <!-- End Page Title -->
        <form method="post" id="AddProForm" action="{{ route('admin.updateProduct',['id'=>$product->idPro]) }}"
            enctype="multipart/form-data" class="row mt-4">
            @csrf
            @method('PUT')
            <div class="form-group col-md-8">
                <label style="font-weight: bolder;" class="control-label">Tên sản phẩm</label>
                <input class="form-control" id="namepro" value="{{ $product->namePro }}" name="namepro"
            ...
            <div class="form-check ms-3">
                ...
                <input type="checkbox" class="form-check-input" checked name="hotPro" value="1">
                @else
                <input type="hidden" name="hotPro" value="0">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control" value="{{ $product->count }}" onclick="checkCount()" onchange="checkCount()"
                    name="countpro" id="countpro" type="text" required>
            </div>
            <div class="form-group col-md-4">
                <label style="font-weight: bolder;" class="control-label mt-3">Giá bán(VND)</label>
                <input class="form-control" id="giabanpro" value="{{ $product->cost }}" name="giabanpro"
            ...
            <div class="form-group  col-md-4">
                ...
                <input class="form-control" id="giavonpro" name="discount" value="{{ $product->discount }}"
            ...
            <div class="form-group ">
                ...
                <textarea id="mota" name="mota" class="form-control">{{ $product->description }} </textarea>
            ...
            <button class="btn btn-success mt-4 ms-2" type="submit" id="buttonAddPro" style="width:10%"
                name="addproduct">Sửa
            </button>

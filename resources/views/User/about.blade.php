  ...
  <div class="about-left d-flex flex-column justify-content-between">
    <div class="about-left-1 text-right">
      <span>
        ...
        <p>Ngoài các yếu tố về chất lượng sản phẩm, cửa hàng uy tín, chuyên nghiệp cần mang đến sản phẩm với mức giá cả
          phải chăng</p>
      </span>
    </div>
  ...
  <div class="about-right d-flex flex-column justify-content-between">
    <div class="about-right-1 text-left">
      <span>
        ...
        <p>Một trong những tiêu chí quan trọng của cửa hàng là mang đến những sản phẩm uy tín chất lượng đến khách hàng
        </p>
      </span>
    </div>

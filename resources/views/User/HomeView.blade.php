...
<div class="container-fluid" style="margin-top:100px">
    <img class="w-100" src="{{ asset('assets/img/banner_collection.webp') }}">
</div>
<!--Hot product-->
        ...
        <div class="product-box">
            <div class="product-inner-box ">
                ...
                <a href="{{ route('user.productDetail',['id'=>$row->idPro]) }}"><img
                        src="{{ asset('assets/img-add-pro/'.$row->getImgProduct($row->idPro)) }}" alt="img-fluid"></a>
            ...
            <div class="product-info">
                ...
                <div class="product-price">
                    ...
                    <p class=" text-danger fs-5">{{ number_format($row->cost - ($row->cost * $row->discount) / 100); }}đ
                        @else
